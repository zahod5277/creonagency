                ...
                <div class="form-call">
                    <div class="width-site">
                        <div class="call-left">
                            ...
                            <h4><i></i>Звоните<a class="comagic_phone" href="tel:{$_modx->config.phone_code} {$_modx->config.phone_number}"><b>{$_modx->config.phone_code} </b>{$_modx->config.phone_number}</a></h4>
                            <h6>или</h6>
                            <div class="parent">
