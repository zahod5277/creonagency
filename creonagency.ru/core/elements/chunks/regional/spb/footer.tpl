    ...
    <div class="width-site">
        ...
        <div class="b_two">
            ...
            <ul class="footer_list">
                ...
                <li><a href="tajnyij-pokupatel.html">Тайный покупатель</a></li>
                <li><a href="personal-dlya-podderzhki-meropriyatiya.html">Персонал для мероприятий</a></li>
                <li><a href="sempling.html">Сэмплинг</a></li>
                <li><a href="razdacha-listovok.html">Лифлетинг</a></li>
                <li><a href="organizacziya-i-provedenie-anketirovaniya.html">Проведение опросов</a></li>
            </ul>
        </div>
        <div class="b_three">
            <h3>Акции</h3>
            <ul class="footer_list">
                ...
                <li><a href="btl-akczii.html">BTL акции</a></li>
                <li><a href="event-marketing.html">Event маркетинг</a></li>
                <li><a href="provedenie-degustaczij.html">Дегустация</a></li>
                ...
                <li><a href="ctimulirovanie-prodazh.html">Стимулирование продаж</a></li>
        ...
        <div class="b_four">
            ...
            <h3 class="col_4"><a href="{'2217'|url}">Блог</a></h3>
